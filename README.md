...
curl.exe -X POST http://127.0.0.1:8000/api/data -H "Content-Type: application/json" -d "{\"user_id\": 1, \"value\": 99.5}"
Invoke-RestMethod -Uri "http://127.0.0.1:8000/api/data" -Method Post -Headers @{"Content-Type"="application/json"} -Body '{"user_id": 1, "value": 99.5}'
